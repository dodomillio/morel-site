(function () {
  ...
  if (!overlay || !mobileMenu || !cartDrawer || !searchDrawer) return;
  ...
  document.querySelectorAll("[data-mobile-open]").forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      const panel = mobileMenu.querySelector(`[data-mobile-panel="${target}"]`);
  ...
  function closeAllMegaMenus() {
    ...
    document.querySelectorAll("[data-has-submenu].is-open").forEach((item) => item.classList.remove("is-open"));
  }
